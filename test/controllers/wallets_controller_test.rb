...
class WalletsControllerTest < ActionController::TestCase
  ...
  test "should create wallet" do
    assert_difference('Wallet.count') do
      post :create, wallet: { brand: @wallet.brand, description: @wallet.description, name: @wallet.name, price: @wallet.price }
    end
  ...
  test "should update wallet" do
    patch :update, id: @wallet, wallet: { brand: @wallet.brand, description: @wallet.description, name: @wallet.name, price: @wallet.price }
    assert_redirected_to wallet_path(assigns(:wallet))
  end
